...
struct Genode::Local_connection_base : Noncopyable
{
	...
	protected:
		...
		Local_connection_base(Service &service,
		                      ...
		                      Parent::Client::Id id,
		                      Args const &args, size_t ram_quota)
		:
			_session_state(service, id_space, id, _init_args(args, ram_quota), Affinity())
		{
...
class Genode::Local_connection : Local_connection_base
{
	...
	public:
		...
		:
			Local_connection_base(service, id_space, id, args, CONNECTION::RAM_QUOTA)
		{
